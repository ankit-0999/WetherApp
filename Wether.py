...
def data_get():
    city = city_name.get()
    data = requests.get(
        "https://api.openweathermap.org/data/2.5/weather?q=" + city + "&appid=dac8d6c0ee2b6ff7dc9dc75ee955e210").json()

    w_label1.config(text=data["weather"][0]["main"])
    wb_label1.config(text=data["weather"][0]["description"])
    temp_label1.config(text=float(data["main"]["temp"] - 273.15))
...
w_label1 = Label(win, text="", font=("Time New Roman", 30))
...
temp_label.place(x=20, y=400, height=50, width=210)

temp_label1 = Label(win, text="", font=("Time New Roman", 20))
temp_label1.place(x=250, y=400, height=50, width=200)

w_label = Label(win, text="pressure", font=("Time New Roman", 20))
w_label.place(x=25, y=470, height=50, width=200)

wp_label1 = Label(win, text="", font=("Time New Roman", 20))
wp_label1.place(x=250, y=470, height=50, width=200)
